# This file was automatically generated by regen-py.pl at 20210923-101352
...
class DerivAPICalls:
    ...
    # __init__() { }
    async def accountClosure(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def accountSecurity(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def accountStatistics(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def activeSymbols(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def affiliateAccountAdd(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def apiToken(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def appDelete(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def appGet(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def appList(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def appMarkupDetails(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def appRegister(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def appUpdate(self, args = None): 
        """
        param args {Dict}
        param args.app_markup_percentage {Number}: [Optional] Markup to be added to contract prices (as a percentage of contract payout).
        ...
        return await self.processRequest(allArgs)
    async def assetIndex(self, args = None): 
        """
        param args {Dict}
    ...
    async def buy(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def buyContractForMultipleAccounts(self, args = None): 
        """
        param args {Dict}
    ...
    async def cashier(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def cashierPayments(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def cashierWithdrawalCancel(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def changePassword(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def contractUpdate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def contractUpdateHistory(self, args = None): 
        """
        param args {Dict}
        param args.contract_id {Number}: Internal unique contract identifier.
        ...
        return await self.processRequest(allArgs)
    async def contractsFor(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def copyStart(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def copyStop(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def copytradingList(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def copytradingStatistics(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def documentUpload(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def economicCalendar(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def exchangeRates(self, args = None): 
        """
        param args {Dict}
    ...
    async def forget(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def forgetAll(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def getAccountStatus(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def getFinancialAssessment(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def getLimits(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def getSelfExclusion(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def getSettings(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def identityVerificationDocumentAdd(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def landingCompany(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def landingCompanyDetails(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def linkWallet(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def loginHistory(self, args = None): 
        """
        param args {Dict}
    ...
    async def logout(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def mt5Deposit(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def mt5GetSettings(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def mt5LoginList(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def mt5NewAccount(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def mt5PasswordChange(self, args = None): 
        """
        param args {Dict}
        param args.login {String}: MT5 user login
        ...
        return await self.processRequest(allArgs)
    async def mt5PasswordCheck(self, args = None): 
        """
        param args {Dict}
        param args.login {String}: MT5 user login
        ...
        return await self.processRequest(allArgs)
    async def mt5PasswordReset(self, args = None): 
        """
        param args {Dict}
        param args.login {String}: MT5 user login
        ...
        return await self.processRequest(allArgs)
    async def mt5Withdrawal(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def newAccountMaltainvest(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def newAccountReal(self, args = None): 
        """
        param args {Dict}
        param args.account_opening_reason {String}: [Optional] Purpose and reason for requesting the account opening.
        param args.account_turnover {String}: [Optional] The anticipated account turnover.
        ...
        return await self.processRequest(allArgs)
    async def newAccountVirtual(self, args = None): 
        """
        param args {Dict}
        param args.affiliate_token {String}: [Optional] Affiliate token, within 32 characters.
        ...
        return await self.processRequest(allArgs)
    async def newAccountWallet(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def notificationEvent(self, args = None): 
        """
        param args {Dict}
        param args.args {Any}: 
        ...
        return await self.processRequest(allArgs)
    async def oauthApps(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertCreate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertInfo(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertList(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertUpdate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertiserAdverts(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertiserCreate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertiserInfo(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertiserPaymentMethods(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertiserRelations(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pAdvertiserUpdate(self, args = None): 
        """
        param args {Dict}
        param args.contact_info {String}: [Optional] Advertiser's contact information, to be used as a default for new sell adverts.
        param args.default_advert_description {String}: [Optional] Default description that can be used every time an advert is created.
        ...
        return await self.processRequest(allArgs)
    async def p2pChatCreate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pOrderCancel(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pOrderConfirm(self, args = None): 
        """
        param args {Dict}
        param args.id {String}: The unique identifier for this order.
        ...
        return await self.processRequest(allArgs)
    async def p2pOrderCreate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pOrderDispute(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pOrderInfo(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pOrderList(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def p2pPaymentMethods(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def paymentMethods(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def paymentagentCreate(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def paymentagentDetails(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        ...
        return await self.processRequest(allArgs)
    async def paymentagentList(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def paymentagentTransfer(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def paymentagentWithdraw(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def payoutCurrencies(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
    ...
    async def portfolio(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def profitTable(self, args = None): 
        """
        param args {Dict}
        param args.contract_type {Any}: Return only contracts of the specified types
    ...
    async def proposal(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def proposalOpenContract(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def realityCheck(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        ...
        return await self.processRequest(allArgs)
    async def requestReport(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def resetPassword(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def residenceList(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
        ...
        return await self.processRequest(allArgs)
    async def revokeOauthApp(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
    ...
    async def sell(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def sellContractForMultipleAccounts(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.price {Number}: Minimum price at which to sell the contract, or `0` for 'sell at market'.
        ...
        return await self.processRequest(allArgs)
    async def sellExpired(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
        ...
        return await self.processRequest(allArgs)
    async def serviceToken(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def setAccountCurrency(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
        ...
        return await self.processRequest(allArgs)
    async def setFinancialAssessment(self, args = None): 
        """
        param args {Dict}
        param args.account_turnover {String}: [Optional] The anticipated account turnover.
        param args.binary_options_trading_experience {String}: [Optional] Binary options trading experience.
        ...
        return await self.processRequest(allArgs)
    async def setSelfExclusion(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def setSettings(self, args = None): 
        """
        param args {Dict}
    ...
    async def statement(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def statesList(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
    ...
    async def ticks(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def ticksHistory(self, args = None): 
        """
        param args {Dict}
...
- For `"style": "candles"`: it will default to 1 day ago if count or granularity is undefined.
    ...
    async def time(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def tncApproval(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
        ...
        return await self.processRequest(allArgs)
    async def topupVirtual(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
        ...
        return await self.processRequest(allArgs)
    async def tradingDurations(self, args = None): 
        """
        param args {Dict}
        param args.landing_company {String}: [Optional] If specified, will return only the underlyings for the specified landing company.
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformAccounts(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformDeposit(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformInvestorPasswordChange(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformInvestorPasswordReset(self, args = None): 
        """
        param args {Dict}
        param args.account_id {String}: Trading account ID.
        param args.new_password {String}: New password of the account. For validation (Accepts any printable ASCII character. Must be within 8-25 characters, and include numbers, lowercase and uppercase letters. Must not be the same as the user's email address).
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformNewAccount(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformPasswordChange(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformPasswordReset(self, args = None): 
        """
        param args {Dict}
        param args.new_password {String}: New password of the account. For validation (Accepts any printable ASCII character. Must be within 8-25 characters, and include numbers, lowercase and uppercase letters. Must not be the same as the user's email address).
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        ...
        return await self.processRequest(allArgs)
    async def tradingPlatformWithdrawal(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def tradingServers(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def tradingTimes(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
    ...
    async def transaction(self, args = None): 
        ...
        return await self.processRequest(allArgs)
    async def transferBetweenAccounts(self, args = None): 
        """
        param args {Dict}
        ...
        return await self.processRequest(allArgs)
    async def verifyEmail(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
        ...
        return await self.processRequest(allArgs)
    async def websiteStatus(self, args = None): 
        """
        param args {Dict}
        param args.passthrough {Any}: [Optional] Used to pass data through the websocket, which may be retrieved via the `echo_req` output field.
        param args.req_id {Number}: [Optional] Used to map request to response.
