# This file was automatically generated by regen-py.pl at 20210923-121731
...
class DerivAPICalls:
    ...
    async def account_closure(self, args = None): 
        ...
        return await self.process_request(allArgs)
...
- For `"style": "candles"`: it will default to 1 day ago if count or granularity is undefined.
    ...
    async def process_request(self, allArgs):
